...
opval2 = 'samedir';
nsubj = 100;
filename1 = sprintf('Stats_2D_complete_%s_%s_%s_asym_z.mat', vari1, vari2, opval1);
filename2 = sprintf('Stats_2D_complete_%s_%s_%s_asym_z.mat', vari1, vari2, opval2);
...
subplot(2, 3, 4)
imagesc(varparam1, varparam2, FASMOVI')
set(gca, 'Ydir', 'normal')
...
subplot(2, 3, 5)
imagesc(varparam1, varparam2, FASJSD')
set(gca, 'Ydir', 'normal')
...
subplot(2, 3, 6)
imagesc(varparam1, varparam2, diffFAS')
hold on;
...
caxis([-1 1])
c = colorbar;
c.Label.String = 'Differnce in False Alarms';

% subplot(3, 3, 7)
% imagesc(varparam1, varparam2, MOVI_PPV')
% set(gca, 'Ydir', 'normal')
...
% 
% subplot(3, 3, 8)
% imagesc(varparam1, varparam2, JSD_PPV')
% set(gca, 'Ydir', 'normal')
